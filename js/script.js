...
var themeToggle = $('div.header_theme')
var themeToggleIcon = $('span.header_theme_icon')
...
themeToggle.addEventListener('click', () => {
    body.classList.contains('darkmode') ? liteMode() : darkMode()
})

window.localStorage.getItem('mode') == 'lite' ? liteMode() : darkMode()
